  ...
  return (
    <>
      ...
      >
        ...
        {/* DESKTOP VIEW (TILES)================================================================================================ */}
        {isAboveMd ? (
          <div className="xl:w-5/6 h-full flex flex-col items-center justify-center gap-12 landscape-mobile:gap-3 font-quest text-gray-100 pb-8">
          ...
          <div className="flex flex-col h-full items-center justify-center gap-20 landscape-mobile:gap-8 se-mobile:gap-4 pt-4 se-mobile:pt-0 se:pt-0">
            <motion.div
              initial="hidden"
              whileInView="visible"
              className="z-10 font-quest flex flex-col gap-8 landscape-mobile:gap-4 text-base md:text-lg se-mobile:text-sm"
              viewport={{ once: true, amount: 0.5 }}
            ...
            >
              ...
              <div className="flex flex-col items-center justify-between gap-8 py-6 text-quest w-full">
                <div className="flex-1">
                  ...
                  <p className="text-text-supporting text-base">
                    Hundreds of short videos from basic to advanced, all
